 ...
 * Parameters:
 * signature - buffer of signature
 * sig_len - length of signature (in bytes)
 * cipher - buffer of cipher
...
// Given the unpadded size, output the padded size
...
//     Declaring variables used in method
  int      read         =  0;
  int      index        =  0;
  int      pindex       = -1;
  int      frame_length =  16;
